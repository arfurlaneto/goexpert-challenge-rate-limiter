...
// Source: ./ratelimiter/adapter/storage_adapter.go
//
...
func (mr *MockRateLimitStorageAdapterMockRecorder) AddBlock(ctx, keyType, key, milliseconds any) *gomock.Call {
...
func (mr *MockRateLimitStorageAdapterMockRecorder) GetBlock(ctx, keyType, key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockRateLimitStorageAdapterMockRecorder) IncrementAccesses(ctx, keyType, key, maxAccesses any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
