...
// Source: ./ratelimiter/responsewriter/response_writer.go
//
...
func (mr *MockRateLimiterResponseWriterMockRecorder) WriteError(w, err any) *gomock.Call {
...
func (mr *MockRateLimiterResponseWriterMockRecorder) WriteResponse(w any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
